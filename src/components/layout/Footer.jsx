            ...
            <div className="mb-6">
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-3 rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm placeholder:text-gray-400"
                />
                <button
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="/events"
                  className="group text-gray-600 hover:text-purple-600 transition-colors flex items-center gap-2"
                >
                  <span className="w-1 h-1 bg-purple-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Events & Programs
                </a>
              </li>
              <li>
